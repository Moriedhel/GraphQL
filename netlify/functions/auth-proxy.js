...
// Forwards POST /api/auth/signin to Zone01 and fixes CORS headers.
...
exports.handler = async function(event, context) {
  ...
  const resBody = await forwardRequest('https://platform.zone01.gr/api/auth/signin', {
    method: 'POST',
...
function filterHeaders(h) {
  ...
  return {
    ...
    'Content-Type': copy['Content-Type'] || 'text/plain',
